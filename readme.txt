...
Extends the TinyMCE color picker with a lot more colors to choose from.
...
This plugin should works out of the box with a standard installation of WordPress.
...
1. This grid is what you'll get
2. .. and here you can define your own colors!
